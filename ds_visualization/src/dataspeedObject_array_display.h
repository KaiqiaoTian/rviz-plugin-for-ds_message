...
{
  class DataspeedObjectArrayDisplay: public DataspeedObjectDisplayCommon<ds_av_msgs::DataspeedObjectArray>
  {
  Q_OBJECT
  public:
    DataspeedObjectArrayDisplay();
    virtual ~DataspeedObjectArrayDisplay();
  ...
  protected:
    ...
    ds_av_msgs::DataspeedObjectArray::ConstPtr latest_msg_;
    protected Q_SLOTS:
    void updateColor();
    void updateAlpha();
    void updateOnlyEdge();
  ...
  private:
    void processMessage(const ds_av_msgs::DataspeedObjectArray::ConstPtr& msg);
  };
